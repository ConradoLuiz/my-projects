...
public class pianoVirtual extends PApplet {
...
public void setup() {
  ...
  naturals[0] = 220;
  naturals[1] = 246.9417f;
  naturals[2] = 261.6256f;
  naturals[3] = 293.6648f;
  naturals[4] = 329.6276f;
  naturals[5] = 349.2282f;
  naturals[6] = 391.9954f;
...
public void downOct() {
  for (int i=0; i < 10; i++) {
    naturals[i] = naturals[i] / 2.0f;
    notas.get(i).freq(naturals[i]);
  }

  for (int i=0; i < 6; i++) {
    sharps[i] = sharps[i] / 2.0f;
    notas2.get(i).freq(sharps[i]);
  }
...
public class Nota{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "pianoVirtual" };
    if (passedArgs != null) {
